 ...
 *
 //rtsp://192.168.1.170:554/11  ipcamera
 http://91.135.105.120
  http://192.168.2.105:9898/api/getinfo?ip=91.135.105.120/&port=9090&username=admin&password=2468Tohar
  {"onvif...":"rtsp://195.133.159.74:554/11"}
  http://192.168.1.106:9898/api/getinfo?ip=185.246.255.204/&port=8080&username=admin&password=Aa12345678
  http://localhost:5000/api/getinfo?ip=37.142.115.48&username=admin&password=a1234
  http://localhost:5000/api/getinfo?ip=82.81.67.110&username=1&password=1 
  
   http://localhost:5000/api/getinfo?ip=213.57.21.146&username=admin&password=etc2017 
   
   http://localhost:5000/api/getinfo?ip=62.90.161.191:8181&username=admin&password=123456 
   
   http://localhost:5000/api/getinfo?ip=62.90.161.191:8181&username=admin&password=123456&port=94
   //http://10.76.10.101/
 http://127.0.0.1:9898/api/getinfo?ip=10.76.10.101&port=80&username=admin&password=Bb@12345
...
var IP_RANGE_START = '37.142.115.48',
    ...
    PORT_LIST = [9090,80,85,90,7575, 8000, 8080, 8081,8088,8181],
    USERNAME = 'admin',
    PASSWORD = 'a1234';

var Cam = require('onvif').Cam;
var flow = require('nimble');
console.log('load onvif ...');
onvifrouter.get('/getinfo', function (req, res) {
	 ...
	 let port =  req.body.port ? req.body.port : '81',
     IP_RANGE_START = ip ,
     IP_RANGE_END = ip ,
     PORT_LIST = [9090,80,85,90,91,7575, 8000, 8080, 8081,8088,5251,5250,8181,port],
     USERNAME = username ,
     PASSWORD = password ;
	 console.log('text');
